 ...
 */
export const getBalanceBase = async (params: GetBalanceParams, admin?: string, adminpwd?: string) => {
  try {
 ...
 */
export const getTokenBalanceBase = async (params: GetTokenBalanceParams, admin?: string, adminpwd?: string) => {
  try {
    const url = `${getBaseURL()}/cryptoutils/`;
 ...
 */
export const getTransactionsBase = async (params: GetTransactionsParams, admin?: string, adminpwd?: string) => {
  try {
    const url = `${getBaseURL()}/cryptoutils/`;
    const data = {
      op: "get_transactions",
 ...
 */
export const getTokenTransactionsBase = async (params: GetTokenTransactionsParams, admin?: string, adminpwd?: string) => {
  try {
    const url = `${getBaseURL()}/cryptoutils/`;
    const paramsArray: any[] = [
      { name: "address", value: params.address },
 ...
 */
export const bridgeTokenBase = async (params: BridgeTokenParams, admin?: string, adminpwd?: string) => {
  try {
    const url = `${getBaseURL()}/cryptoutils/`;
    const data = {
      op: "bridge_token",
 ...
 */
export const getBridgeTokenFeeBase = async (params: GetBridgeTokenFeeParams, admin?: string, adminpwd?: string) => {
  try {
    const url = `${getBaseURL()}/cryptoutils/`;
    const data = {
