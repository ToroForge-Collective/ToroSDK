 ...
 */
export const getBalanceArbitrum = async (params: GetBalanceParams, admin?: string, adminpwd?: string) => {
  try {
 ...
 */
export const getTokenBalanceArbitrum = async (params: GetTokenBalanceParams, admin?: string, adminpwd?: string) => {
  try {
    const url = `${getBaseURL()}/cryptoutils/`;
 ...
 */
export const getTransactionsArbitrum = async (params: GetTransactionsParams, admin?: string, adminpwd?: string) => {
  try {
    const url = `${getBaseURL()}/cryptoutils/`;
    const data = {
      op: "get_transactions",
 ...
 */
export const getTokenTransactionsArbitrum = async (params: GetTokenTransactionsParams, admin?: string, adminpwd?: string) => {
  try {
    const url = `${getBaseURL()}/cryptoutils/`;
    const paramsArray: any[] = [
      { name: "address", value: params.address },
 ...
 */
export const bridgeTokenArbitrum = async (params: BridgeTokenParams, admin?: string, adminpwd?: string) => {
  try {
    const url = `${getBaseURL()}/cryptoutils/`;
    const data = {
      op: "bridge_token",
 ...
 */
export const getBridgeTokenFeeArbitrum = async (params: GetBridgeTokenFeeParams, admin?: string, adminpwd?: string) => {
  try {
    const url = `${getBaseURL()}/cryptoutils/`;
    const data = {
